...
public class ExampleFluidScreen extends AbstractContainerScreen<ExampleFluidMenu> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(TutorialMod.MODID,
            "textures/gui/example_fluid.png");

    public ExampleFluidScreen(ExampleFluidMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
